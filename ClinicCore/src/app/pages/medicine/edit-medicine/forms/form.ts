...
export class Form extends DynamicForm {
    ...
    public Build() {
        ...
        this.medicineService.GetById(this.uid).subscribe(firestoreData => {
            this.patchValue(firestoreData.data);
    ...
    private _salvaDados(sanitizeValues: any) {
        this.medicineService.Update(this.uid, sanitizeValues).subscribe(this._allRight.bind(this), this._filterErrors);
    }
