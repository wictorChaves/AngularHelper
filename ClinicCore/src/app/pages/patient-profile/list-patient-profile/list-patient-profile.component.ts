...
@Component({
  selector   : 'app-list-patient-profile',
  templateUrl: './list-patient-profile.component.html',
  styleUrls  : ['./list-patient-profile.component.css'],
  providers  : [
    LoadingHelper,
    FireFunctionMsg
  ]
})
export class ListPatientProfileComponent implements OnInit {
